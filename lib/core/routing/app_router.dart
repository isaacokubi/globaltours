...
class AppRouter {
  ...
  static Route<dynamic> onGenerateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case tours: return MaterialPageRoute(builder: (_) => const ToursScreen());
      case tour: return MaterialPageRoute(builder: (_) => TourDetailScreen(tour: settings.arguments as Map<String, dynamic>));
      case bookings: return MaterialPageRoute(builder: (_) => const MyBookingsScreen());
      case admin: return MaterialPageRoute(builder: (_) => const AdminDashboardScreen());
      case finance: return MaterialPageRoute(builder: (_) => const FinanceScreen());
